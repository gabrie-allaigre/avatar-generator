...
public class AvatarUtils {
     ...
     * @return new image
     */
    public static BufferedImage resizeImage(Image src, int width, int height) {
     ...
     * @return new image
     */
    public static BufferedImage planImage(Image src, int width, int height) {
        BufferedImage dest = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = dest.createGraphics();
        g2.drawImage(src, (width - src.getWidth(null)) / 2, (height - src.getHeight(null)) / 2, null);
        g2.dispose();
        return dest;
    }
